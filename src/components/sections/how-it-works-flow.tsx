      ...
      <div className="container">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          {steps.map((step) => (
            <Card
              key={step.step}
              className="text-center transition-transform duration-300 hover:scale-105 hover:shadow-xl relative"
            >
              <CardHeader>
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-primary text-primary-foreground rounded-full h-8 w-8 flex items-center justify-center font-bold text-lg">
                  {step.step}
                </div>
